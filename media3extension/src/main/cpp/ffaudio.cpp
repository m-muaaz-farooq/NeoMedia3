...
Java_com_muaaz_neomedia3_FfmpegAudioDecoder_ffmpegInitialize(JNIEnv *env, jobject thiz,
                                                             jstring codec_name,
    ...
    jclass clazz = env->FindClass("com/muaaz/neomedia3/FfmpegAudioDecoder");
...
Java_com_muaaz_neomedia3_FfmpegAudioDecoder_ffmpegDecode(JNIEnv *env, jobject thiz, jlong context,
                                                         jobject input_data, jint input_size,
                                                         jobject decoderOutputBuffer,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_muaaz_neomedia3_FfmpegAudioDecoder_ffmpegGetChannelCount(JNIEnv *env, jobject thiz,
                                                                  jlong context) {
    if (!context) {
        LOGE("Context must be non-NULL.");
        return -1;
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_muaaz_neomedia3_FfmpegAudioDecoder_ffmpegGetSampleRate(JNIEnv *env, jobject thiz,
                                                                jlong context) {
    if (!context) {
        LOGE("Context must be non-NULL.");
        return -1;
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_muaaz_neomedia3_FfmpegAudioDecoder_ffmpegReset(JNIEnv *env, jobject thiz, jlong jContext,
                                                        jbyteArray extra_data) {
...
Java_com_muaaz_neomedia3_FfmpegAudioDecoder_ffmpegRelease(JNIEnv *env, jobject thiz,
                                                          jlong context) {
    if (context) {
