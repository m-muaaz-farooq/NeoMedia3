...
Java_com_muaaz_neomedia3_FfmpegVideoDecoder_ffmpegInitialize(JNIEnv *env, jobject thiz,
                                                             jstring codec_name,
                                                             jbyteArray extra_data, jint threads) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_muaaz_neomedia3_FfmpegVideoDecoder_ffmpegReset(JNIEnv *env, jobject thiz, jlong jContext) {
...
Java_com_muaaz_neomedia3_FfmpegVideoDecoder_ffmpegRelease(JNIEnv *env, jobject thiz,
                                                          jlong jContext) {
    auto *const jniContext = reinterpret_cast<JniContext *>(jContext);
    AVCodecContext *context = jniContext->codecContext;
    if (context) {
...
Java_com_muaaz_neomedia3_FfmpegVideoDecoder_ffmpegRenderFrame(JNIEnv *env, jobject thiz,
                                                              jlong jContext, jobject surface,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_muaaz_neomedia3_FfmpegVideoDecoder_ffmpegSendPacket(JNIEnv *env, jobject thiz,
                                                             jlong jContext, jobject encoded_data,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_muaaz_neomedia3_FfmpegVideoDecoder_ffmpegReceiveFrame(JNIEnv *env, jobject thiz,
                                                               jlong jContext, jint output_mode,
                                                               jobject output_buffer,
