...
jobject
frame_extractor_get_frame(JNIEnv *env, int64_t jFrameLoaderContextHandle, int64_t time_millis) {
    auto *frameLoaderContext = frame_loader_context_from_handle(jFrameLoaderContextHandle);
...
Java_com_muaaz_neomedia3_mediaInformation_FrameLoader_nativeRelease(JNIEnv
*env,
jclass clazz,
        jlong
jFrameLoaderContextHandle) {
frame_loader_context_free(jFrameLoaderContextHandle);
}
extern "C"
JNIEXPORT jboolean
JNICALL
        Java_com_muaaz_neomedia3_mediaInformation_FrameLoader_nativeLoadFrame(JNIEnv * env, jclass
clazz,
...
bool successfullyLoaded = frame_extractor_load_frame(env, jFrameLoaderContextHandle,
                                                     time_millis, jBitmap);
return static_cast
<jboolean>(successfullyLoaded);
}
extern "C"
JNIEXPORT jobject
JNICALL
        Java_com_muaaz_neomedia3_mediaInformation_FrameLoader_nativeGetFrame(JNIEnv * env, jclass
clazz,
jlong jFrameLoaderContextHandle,
        jlong
time_millis) {
return
frame_extractor_get_frame(env, jFrameLoaderContextHandle, time_millis
);
}